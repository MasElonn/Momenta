...
<header class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full py-2 bg-navbar border-b border-navbar-line">
    <nav class="max-w-340 w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between">
        <img src="{{ asset("images/Logo.svg") }}" alt="Logo" width="110" height="10" >
        ...
        <div class="flex flex-row items-center gap-5 mt-5 sm:justify-center sm:mt-0 sm:ps-5">
            ...
            <a class="text-sm text-navbar-nav-foreground hover:text-primary-hover focus:outline-hidden focus:text-primary-focus" href="/service">Service</a>
            <a class="text-sm text-navbar-nav-foreground hover:text-primary-hover focus:outline-hidden focus:text-primary-focus" href="/about">About</a>
