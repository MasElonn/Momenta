...
<header class="px-8 pb-[60px] pt-[88px]">
    <div class="mx-auto grid max-w-[1180px] grid-cols-1 items-center gap-14 md:grid-cols-[1.05fr_0.95fr]">
        <div>
            <div class="mb-5 inline-flex items-center gap-2 rounded-full bg-accent-soft px-3 py-1.5 text-[12.5px] font-semibold tracking-wide text-accent before:h-1.5 before:w-1.5 before:rounded-full before:bg-accent">
                Untuk acara sekolah
            </div>

            <h1 class="font-display text-[34px] font-bold leading-[1.12] tracking-tight text-navy md:text-[46px]">
                Atur fotografer,<br>simpan hasilnya,<br>
                <span class="text-brand">bagikan ke orang tua.</span>
            </h1>

            <p class="mt-5 max-w-[480px] text-[16.5px] leading-relaxed text-ink-soft">
        ...
        <div class="overflow-hidden rounded-2xl border border-line bg-surface shadow-[0_30px_60px_-30px_rgba(11,42,140,0.3)]">
            <div class="flex items-start justify-between px-6 pb-5 pt-[22px]">
                ...
                <span class="rounded-full bg-accent-soft px-2.5 py-1.5 text-[11.5px] font-semibold text-accent">Terjadwal</span>
            </div>
...
<section id="harga" class="border-y border-line bg-surface px-8 py-20">
    <div class="mx-auto max-w-[1180px]">
        ...
        <div class="grid grid-cols-1 items-stretch gap-6 md:grid-cols-3">
            {{-- Paket Dasar --}}
            <div class="flex flex-col rounded-2xl border border-line bg-page p-8">
            ...
            <div class="relative flex scale-[1.03] flex-col rounded-2xl border border-navy bg-navy p-8 text-surface shadow-[0_30px_60px_-25px_rgba(11,42,140,0.45)]">
...
<section class="px-8 py-20">
    <div class="mx-auto flex max-w-[1180px] flex-col flex-wrap items-start justify-between gap-8 rounded-3xl bg-navy p-9 sm:p-12 md:flex-row md:items-center">
        <div>
